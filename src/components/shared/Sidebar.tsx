    ...
    <>
      ...
      <aside
        className={cn(
          ...
          'bg-[#3D005E]',
          /* Width: full-screen on mobile, fixed on desktop */
          'w-full lg:w-auto',
          collapsed ? 'lg:w-[68px]' : 'lg:w-[220px]',
          /* Slide animation: off-screen on mobile unless open; always visible on desktop */
      ...
      >
        ...
        <div className="flex items-center h-16 px-4 border-b border-white/10 shrink-0">
          ...
          <button
            onClick={onMobileClose}
            className="lg:hidden p-1.5 rounded-lg hover:bg-white/10 transition-colors text-white/70 hover:text-white shrink-0 ml-auto"
          ...
          <button
            onClick={onToggle}
            className={cn(
              'hidden lg:flex p-1.5 rounded-lg hover:bg-white/10 transition-colors text-white/70 hover:text-white shrink-0',
              collapsed && 'mx-auto'
            )}
          >
            <List size={18} />
