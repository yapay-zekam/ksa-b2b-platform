...
export const products: Product[] = [
  ...
  },
  {
    ...
    category: 'Poultry',
    image: 'https://images.unsplash.com/photo-1604503468506-a8da13d11d36?w=400&h=400&fit=crop',
    rating: 4.5,
    reviewCount: 987,
    price: 26.75,
    originalPrice: 31.0,
  ...
  {
    id: '11',
    title: 'Sadafco Long Life Cream – 200ml × 24',
    category: 'Dairy',
    image: 'https://images.unsplash.com/photo-1591985666643-9a0f8ad37a7e?w=400&h=400&fit=crop',
    rating: 4.1,
    reviewCount: 543,
    price: 52.0,
    originalPrice: 62.0,
  ...
  {
    id: '12',
    title: 'Barakat Sliced White Button Mushrooms – 400g',
    category: 'Vegetables',
...
export const productDetails: Record<string, ProductDetail> = {
  '1': {
    ...
    images: [
      ...
      'https://images.unsplash.com/photo-1606787619248-f301830a5a57?w=800&h=800&fit=crop',
    ],
    variants: [
